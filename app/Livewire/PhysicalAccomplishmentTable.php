...
class PhysicalAccomplishmentTable extends Component
{
    use WithPagination;
    ...
    public function render(): View
    {
        ...
        $entries = PhysicalAccomplishment::where('project_id', $this->projectId)
        ...
        $years = PhysicalAccomplishment::where('project_id', $this->projectId)
            ->distinct()->orderByDesc('year')->pluck('year');

        return view('livewire.physical-accomplishment-table', compact('entries', 'years'));
    }
}
