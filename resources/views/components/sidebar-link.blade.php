...
$icons = [
    ...
    'academic-cap'       => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l9-5-9-5-9 5 9 5z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l6.16-3.422A12.083 12.083 0 0121 12c0 4.418-4.03 8-9 8S3 16.418 3 12c0-.538.068-1.06.196-1.562L12 14z"/>',
...
<a href="{{ $href }}"
   ...
   style="{{ $active
       ? 'background-color:rgba(253,185,19,0.15);color:#FDB913;'
       : 'color:rgba(255,255,255,0.75);' }}"
   onmouseover="{{ $active ? '' : "this.style.backgroundColor='rgba(255,255,255,0.07)';this.style.color='#fff';" }}"
   onmouseout="{{ $active ? '' : "this.style.backgroundColor='';this.style.color='rgba(255,255,255,0.75)';" }}">

    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        {!! $path !!}
    </svg>

    <span x-show="sidebarOpen ?? true" class="truncate">{{ $slot }}</span>
</a>
