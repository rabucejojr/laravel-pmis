<x-app-layout :title="$project->title . ' — Physical Accomplishments'">
    <div class="mb-6 flex items-start justify-between gap-4">
        <div>
            ...
            <h2 class="text-2xl font-bold" style="color:#003087;">Physical Accomplishments</h2>
        </div>

        @if(auth()->user()->hasRole(['admin', 'encoder']))
        <div class="flex items-center gap-2 shrink-0">
            {{-- Excel import --}}
            <form method="POST" action="{{ route('projects.physical-accomplishments.import', $project) }}"
            ...
            <a href="{{ route('projects.physical-accomplishments.create', $project) }}"
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <livewire:physical-accomplishment-table :projectId="$project->id" />
    </div>
</x-app-layout>
